#!/usr/bin/env python
"""
Package metadata for ai_ta_plugin.
"""
import os
import re
import sys
...
VERSION = get_version('ai_ta_plugin', '__init__.py')
...
setup(
    name='ai_ta_plugin',
    version=VERSION,
    description="""This repo adds a new course tab AI TA Plugin""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Intela',
    author_email='shivam.trivedi@intela.io',
    url='https://github.com/intela/ai_ta_plugin',
    packages=find_packages(
        include=['ai_ta_plugin', 'ai_ta_plugin.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "openedx.course_tab": [
            "ai_ta_plugin = ai_ta_plugin.tabs:AITab",
        ],
        "lms.djangoapp": [
            "ai_ta_plugin = ai_ta_plugin.apps:AiTaPluginConfig",
        ],
        "cms.djangoapp": [
            "ai_ta_plugin = ai_ta_plugin.apps:AiTaPluginConfig",
        ]
