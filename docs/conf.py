...
"""
ai_ta_plugin documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'ai_ta_plugin',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/intela/ai_ta_plugin",
...
#
# html_title = 'ai_ta_plugin v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'This repo adds a new course tab AI TA Plugin',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'ai_ta_plugin'),
                os.path.join(root_path, 'ai_ta_plugin/migrations')])
